...
spring.kafka.consumer.properties.spring.json.trusted.packages=com.tarterware.roadrunner.*
...
sprint.kafka.consumer.group-id=roadrunner-debug-consumer
roadrunner.kafka.topics.vehicle-position=${var.kafka_topic_vehicle_position}
